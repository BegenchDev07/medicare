        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-4">
            <Link to="/" className="flex items-center">
              ...
              <span className="ml-2 text-xl font-semibold text-white">MediCare</span>
            </Link>
            <p className="text-gray-300 text-sm">
              Providing quality healthcare services with a focus on patient care and innovative solutions.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/patient/doctors" className="text-gray-300 hover:text-primary-400 transition-colors text-sm">
                  Find Doctors
                </Link>
              </li>
              <li>
                <Link to="/patient/appointments" className="text-gray-300 hover:text-primary-400 transition-colors text-sm">
                  Appointments
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-300 text-sm">General Medicine</li>
              <li className="text-gray-300 text-sm">Pediatrics</li>
              <li className="text-gray-300 text-sm">Orthopedics</li>
              <li className="text-gray-300 text-sm">Cardiology</li>
              <li className="text-gray-300 text-sm">Dentistry</li>
              <li className="text-gray-300 text-sm">Dermatology</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center">
                ...
                <span className="text-gray-300 text-sm break-all">info@medicare.example</span>
              </div>
            </div>
          </div>
        </div>
